...
- [ ] Corrupted shields: Force/Heavy/SuperMag (weapons 46-48) have no entries in EXE shield config table DS:0x616C. Web port has them functional — either remove or document as intentional web extension.
